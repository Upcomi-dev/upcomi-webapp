...
import { SocialPeopleSheet } from "@/components/social/people-sheet";
...
export function ProfileView({
  ...
  return (
    <div className="mx-auto w-full max-w-[1040px] px-4 pt-8 pb-24 md:px-6">
      <div className="glass rounded-[var(--radius)] p-5 md:p-6">
      ...
      {statsLocked ? (
        <p className="mt-10 rounded-[var(--radius)] border border-white/55 bg-white/55 px-5 py-8 text-center text-sm text-foreground/60">
        ...
        <>
          ...
          {isOwn && (
            <p className="mt-3 max-w-[70ch] text-[13px] leading-relaxed text-foreground/55">
...
function EventSection({
  ...
  return (
    <section className="mt-9">
      <h2 className="mb-4 font-serif text-[22px] leading-tight text-foreground">{title}</h2>
      {events.length === 0 ? (

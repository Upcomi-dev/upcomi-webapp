  ...
  return (
    <div className="space-y-5">
      ...
      <div>
        ...
        <div className="flex flex-wrap items-center gap-2 text-[15px] text-foreground/55 md:text-[13px]">
          {formattedDate && (
            <span>
              {formattedDate}
      ...
      {fullEvent?.description && (
        <div>
          ...
          <p className="whitespace-pre-line text-[15px] leading-[1.7] text-foreground/55 md:text-[13px] md:leading-[1.75]">
            {fullEvent!.description}
          </p>
        </div>
      )}
